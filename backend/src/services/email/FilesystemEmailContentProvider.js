...
/**
 * Concrete implementation that reads HTML templates
 * from the filesystem and performs simple placeholder replacement.
 * @augments IEmailContentProvider
 */
export class FilesystemEmailContentProvider extends IEmailContentProvider {
	/**
