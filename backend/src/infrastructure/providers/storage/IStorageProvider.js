...
export class IStorageProvider {
	 ...
	 * @param {string} folder - The destination folder name (e.g., 'categories').
	 ...
	 * @param {string} folder - The base folder name required for identifying the asset in the provider.
	 * @returns {Promise<void>}
	 */
	async delete(fileUrl, folder) { throw new Error("Method not implemented."); }

	/**
	 * Deletes all assets from the storage provider.
	 * @returns {Promise<void>}
	 */
