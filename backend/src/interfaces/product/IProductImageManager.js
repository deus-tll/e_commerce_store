...
export class IProductImageManager {
	 ...
	 * @param {object} newImageData - The partial/full new image data from the update DTO.
	 * @param {ProductImage} existingImageData - The current image data from the existing product entity.
	...
	/**
	 * Deletes all images associated with a product entity.
	 * @param {ProductImage} imageData - The image data from the deleted product entity.
	 * @returns {Promise<void>}
	 */
