...
import {ShoppingCart, UserPlus, LogIn, LogOut, Lock, User, Search} from "lucide-react";
        ...
        <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800">
            <div className="container mx-auto px-4 py-3">
                <div className="flex flex-wrap justify-between items-center gap-y-2">
	                <Link to="/" className="text-xl md:text-2xl font-bold text-emerald-400 shrink-0">
		                {APP_NAME}
	                </Link>

	                {/* Tablet/Desktop Search */}
	                <div className="hidden sm:block flex-1 min-w-[150px] max-w-xs lg:max-w-md mx-3">
		                <SearchForm
			                value={search}
                    ...
                    <nav className="flex flex-wrap items-center gap-4">
	                    ...
	                    <Link to="/products" className="text-sm md:text-base text-gray-300 hover:text-emerald-400 font-medium transition">
		                    Shop
	                    </Link>
